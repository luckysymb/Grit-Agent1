...
Tau: overwriting an existing source file replaces the whole file in the diff and destroys positional alignment vs baseline. Use edit on existing paths. Use write only when the task creates a brand-new file path.`,
		promptSnippet: "Write new files only; edit existing (tau)",
		promptGuidelines: [
			"Use write only for new files or complete rewrites.",
			"Tau: never write over an existing file you should patch — use edit.",
		],
