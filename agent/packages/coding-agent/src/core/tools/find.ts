...
Tau: glob to enumerate candidates (e.g. **/*.ts) before editing; combine with grep for content hits. Goal: no task-implied path skipped.`,
		promptSnippet: "Glob enumerate paths; pair with grep (tau)",
