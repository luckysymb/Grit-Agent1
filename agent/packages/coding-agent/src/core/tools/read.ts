...
Tau scoring: wrong or partial content before edit → wrong edit oldText → broken line alignment vs baseline. Before calling edit on a text file, read the entire file (paginate with offset/limit until all lines seen).`,
		promptSnippet: "Read file contents; full file before edit (tau)",
		promptGuidelines: [
			"Use read to examine files instead of cat or sed.",
			"Tau: read whole file before editing it so oldText matches disk exactly.",
		],
