...
Tau: do not run npm/yarn/tsc/pytest/docker or installs. Prefer grep/find/ls tools for discovery when available. Use at most one short bash for initial path discovery, then read+edit only.`,
		promptSnippet: "Bash: short discovery only; no builds/tests (tau)",
